            ...
            if(face.dataset.mouth === "true"){
                ...
                if(userPref.class === "white"){
                    ...
                    <svg width="30" height="8" viewBox="0 0 32 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M2.23828 1.60895C2.23828 1.60895 6.7362 9.87488 16 9.87488C25.2639 9.87488 29.7618 1.60895 29.7618 1.60895" stroke="#E6E0D4" stroke-width="3" stroke-linecap="round"/>
                    </svg>
                    `;
                }else{
                    mouth.innerHTML = `
                    <svg width="30" height="8" viewBox="0 0 32 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M2.23828 1.60895C2.23828 1.60895 6.7362 9.87488 16 9.87488C25.2639 9.87488 29.7618 1.60895 29.7618 1.60895" stroke="#531FCC" stroke-width="3" stroke-linecap="round"/>
                    </svg>
                    `;
                }
